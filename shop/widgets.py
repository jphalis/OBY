...
def get_supported_language(language_country_code):
    ...
    # Check full language & country code against the supported languages
    # as there are dual entries in the list eg. zh-CN
    # (assuming that is a language country code)
