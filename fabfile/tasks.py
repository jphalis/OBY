...
configure_instance = [
  ...
  {"action": "apt",
   "params": ["libpq-dev", "nginx", "memcached", "git",
              ...
              "build-essential", "python-pip", "libjpeg-dev"],
  ...
  {"action": "put",
   "params": {"file": "%(BITBUCKET_DEPLOY_KEY_PATH)s",
  ...
  # Create virtualevn
  {"action": "run",
   "params": "mkvirtualenv --no-site-packages %(PROJECT_NAME)s",
  ...
  {"action": "put",
   "params": {"file": "%(FAB_CONFIG_PATH)s/templates/gunicorn.conf.py",
  ...
  {"action": "put_template",
   "params": {"template": "%(FAB_CONFIG_PATH)s/templates/start_gunicorn.bash",
  ...
  # nginx
  {"action": "put",
   "params": {"file": "%(FAB_CONFIG_PATH)s/templates/nginx.conf",
  ...
  {"action": "put_template",
   "params": {"template": "%(FAB_CONFIG_PATH)s/templates/nginx-app-proxy",
  ...
  {"action": "sudo",
   "params": "/etc/init.d/nginx restart", "message": "Restarting nginx"},
  ...
  {"action": "put_template",
   "params": {"template": "%(FAB_CONFIG_PATH)s/templates/supervisord.conf",
  ...
  {"action": "put",
   "params": {"file": "%(FAB_CONFIG_PATH)s/templates/supervisord-init",
...
# Pushes the gunicorn startup script to the servers and restarts the gunicorn
# process, use this if you have made changes to templates/start_gunicorn.bash
reload_gunicorn = [
...
# Pushes the supervisor config files to the servers and restarts the supervisor,
# use this if you  have made changes to templates/supervisord-init or
